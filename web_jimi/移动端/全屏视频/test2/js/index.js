...
preloadImageList.push("title.png", "textBom.png", "rulePic.png", "bg.jpg", "poster.jpg", "btn_card.png", "btn_card1.png", "btn_tel.png", "btn_close.png", "btn_detail.png", "btn_share.png", "btn_tiao.png", "btn_continue.png", "icon10.png", "iconJ.png", "iconQ.png", "iconK.png", "iconA.png", "playerBtn.png", "loadingIcon.png", "loadT.png", "share1.png", "share2.png", "share3.png");
var browser = {
	versions: function() {
	...
	s0ToS1 = function() {
		$(".slide0").removeClass("active").fadeOut(), $(".slide1").fadeIn(), v1.pause()
	};
$(function() 
{
	/*function overscroll(el) 
	{
		el.addEventListener("touchstart", function() {
			...
			0 === top ? el.scrollTop = 1 : currentScroll === totalScroll && (el.scrollTop = top - 1)
		}), el.addEventListener("touchmove", function(evt) {
			el.offsetHeight < el.scrollHeight && (evt._isScroller = !0)
		})
	}*/
	...
	}),/* overscroll(document.querySelector(".ruleDiv")),*/ loadImg(), $(".btn_card, .btn_card1").on("click", function() {
