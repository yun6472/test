...
var simpScroller = (function() {
	...
	var _scroller = function(container, direction, params) {
		...
		// 容器尺寸以及包含滚动的尺寸
		var thisBh=container.parentNode.offsetHeight;
		container.style.height=thisBh+'px';
		//alert(thisBh);
		var sizeContainer = container["client" + Size]||thisBh
		//alert(sizeContainer)
			// 因为有滚动动态加载等情况出现，因此默认为0
		var sizeContainerWithScroll = 0;
